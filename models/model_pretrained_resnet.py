...
class MorphDetection(nn.Module):
    ...
    def __init__(self, args, num_classes=2):
        ...
        # load InceptionResnetV1 with the the pretrained weights of InceptionResnetV1 on the large-scale TWINS dataset with more than 50K morph images
        state_dict = torch.load('./pretrained_weights/TWINS_512_RGB_BALANCED_BATCH32_LR1e-05_MARGIN1.0_77_WEIGHTS_VALID_TWINS_LANDMARK_FINAL.pth')
    ...
    def forward(self, x):
        ...
        applies InceptionResnetV1  for classification.
        ...
        # Feed the residual through InceptionResnetV1  to obtain final classification results
        classification_results = self.resnet(residual)
