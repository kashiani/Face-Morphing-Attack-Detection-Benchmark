...
class MorphDetection(nn.Module):
    ...
    def forward(self, x):
        ...
        """
        # Process the input image through blur gaussian filters to obtain filtered images
        output = kornia.filters.box_blur(x, (3,3), border_type='reflect', normalized=True)
