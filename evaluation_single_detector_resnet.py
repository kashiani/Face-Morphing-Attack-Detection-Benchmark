...
def parse_arguments():
    ...
    parser.add_argument('--model_name',  default = 'model_resnet_vanilla', type=str, help='Name of the model module to import')
...
def main():
    ...
    for label, metrics in metrics_dict.items():
        np.save(os.path.join(args.results_path, f"{args.results_name}_{args.model_name}_{label}_metrics.npy"), metrics)
